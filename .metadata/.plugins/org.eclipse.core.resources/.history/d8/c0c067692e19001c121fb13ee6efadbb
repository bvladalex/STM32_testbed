...
/*
		  ...
		  HD44780_PCF8574_SendInstruction(addr, 0x28);
		  HD44780_PCF8574_SendInstruction(addr, 0x0E);
		  HD44780_PCF8574_SendInstruction(addr, 0x01);
		  HD44780_PCF8574_SendInstruction(addr, 0x80);
		  HD44780_PCF8574_DrawString(addr, "ABCDE");
		  */
